; HAND MODIFIED to test unguarded-insert
...
define i64* @introsortUGI(i64* %x, i64 %x1, i64 %x2) {
  ...
  then:
    ...
    %initial_seg_end = add i64 %x1, 16

    %x4prelim = call i64* @insertion_sort (i64* %xg, i64 %x1, i64 %initial_seg_end)
    %x4 = call i64* @unguarded_insertion_sort (i64* %x4prelim, i64 %initial_seg_end, i64 %x2)
    br label %ctd_if
...
define i64* @unguarded_insertion_sort(i64* %x, i64 %x1, i64 %x2) {
  ...
  while_body:
    %a11 = extractvalue { i64*, i64 } %xb, 0
    %a21 = extractvalue { i64*, i64 } %xb, 1
    %xaa = call i64* @is_unguarded_insert (i64* %a11, i64 %x1, i64 %a21)
    %xba = add i64 %a21, 1
    %xca = insertvalue { i64*, i64 } zeroinitializer, i64* %xaa, 0
    %x5 = insertvalue { i64*, i64 } %xca, i64 %xba, 1
    br label %while_start
...
define { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_introsort_qs_aux_impl({ i64, { i64, i8* } }* %x, i64 %x1, i64 %x2, i64 %x3) {
  ...
  start:
    ...
    %x6 = call { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_introsort_qs_aux_impl_f_05316402 ({ { i64, { i64, i8* } }*, { i64, { i64, i64 } } } %x5)
    ret { i64, { i64, i8* } }* %x6
}
...
define i64* @introsort_aux(i64* %x, i64 %x1, i64 %x2, i64 %x3) {
  ...
  start:
    ...
    %x6 = call i64* @Sorting_Introsort_unat_sort_introsort_qs_aux_impl_f_05297778 ({ i64*, { i64, { i64, i64 } } } %x5)
    ret i64* %x6
}

define i64* @is_unguarded_insert(i64* %x, i64 %x1, i64 %x2) {
...
define { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_introsort_qs_aux_impl_f_05316402({ { i64, { i64, i8* } }*, { i64, { i64, i64 } } } %x) {
  ...
  ctd_ifb:
    ...
    %yaa = call { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_introsort_qs_aux_impl_f_05316402 ({ { i64, { i64, i8* } }*, { i64, { i64, i64 } } } %yd)
    %yba = sub i64 %a2b, 1
    ...
    %x12 = call { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_introsort_qs_aux_impl_f_05316402 ({ { i64, { i64, i8* } }*, { i64, { i64, i64 } } } %x11)
    br label %ctd_ifa
...
define i64* @Sorting_Introsort_unat_sort_introsort_qs_aux_impl_f_05297778({ i64*, { i64, { i64, i64 } } } %x) {
  ...
  ctd_ifb:
    ...
    %yaa = call i64* @Sorting_Introsort_unat_sort_introsort_qs_aux_impl_f_05297778 ({ i64*, { i64, { i64, i64 } } } %yd)
    %yba = sub i64 %a2b, 1
    %yf2 = insertvalue { i64, i64 } zeroinitializer, i64 %a1b, 0
    %tmpib = insertvalue { i64, i64 } %yf2, i64 %yba, 1
    %yg2 = insertvalue { i64, { i64, i64 } } zeroinitializer, i64 %a2c2, 0
    ...
    %x12 = call i64* @Sorting_Introsort_unat_sort_introsort_qs_aux_impl_f_05297778 ({ i64*, { i64, { i64, i64 } } } %x11)
    br label %ctd_ifa
