...
define void @qs_quicksort(i64* %A, i64 %lo, i64 %hi) {
  ...
  start:
    ...
    call void @LLVM_Examples_qs_quicksort_f_04999990 (i64* %A, { i64, i64 } %xa)
    ret void
}

define void @LLVM_Examples_qs_quicksort_f_04999990(i64* %A, { i64, i64 } %x) {
  ...
  then:
    ...
    call void @LLVM_Examples_qs_quicksort_f_04999990 (i64* %A, { i64, i64 } %xe)
    %tmpaa = add i64 %p, 1
    %xg = insertvalue { i64, i64 } zeroinitializer, i64 %tmpaa, 0
    %x1 = insertvalue { i64, i64 } %xg, i64 %hi, 1
    call void @LLVM_Examples_qs_quicksort_f_04999990 (i64* %A, { i64, i64 } %x1)
    br label %ctd_if
