...
define void @qs_quicksort(i64* %A, i64 %lo, i64 %hi) #0 {
  ...
  start:
    ...
    call void @LLVM_Examples_qs_quicksort_f_014018122 (i64* %A, { i64, i64 } %xa)
    ret void
}

define void @LLVM_Examples_qs_quicksort_f_014018122(i64* %A, { i64, i64 } %x) #0 {
  ...
  then:
    ...
    call void @LLVM_Examples_qs_quicksort_f_014018122 (i64* %A, { i64, i64 } %xg)
    %tmpaa = add i64 %p, 1
    %xi = insertvalue { i64, i64 } zeroinitializer, i64 %tmpaa, 0
    %x1 = insertvalue { i64, i64 } %xi, i64 %hi, 1
    call void @LLVM_Examples_qs_quicksort_f_014018122 (i64* %A, { i64, i64 } %x1)
    br label %ctd_if
