...
define { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_introsort_aux_impl({ i64, { i64, i8* } }* %x, i64 %x1, i64 %x2, i64 %x3) {
  ...
  start:
    ...
    %x6 = call { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_introsort_aux_impl_f_09452478 ({ { i64, { i64, i8* } }*, { i64, { i64, i64 } } } %x5)
    ret { i64, { i64, i8* } }* %x6
}
...
define i64* @introsort_aux(i64* %x, i64 %x1, i64 %x2, i64 %x3) {
  ...
  start:
    ...
    %x6 = call i64* @Sorting_Introsort_unat_sort_introsort_aux_impl_f_09433260 ({ i64*, { i64, { i64, i64 } } } %x5)
    ret i64* %x6
}
...
define { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_introsort_aux_impl_f_09452478({ { i64, { i64, i8* } }*, { i64, { i64, i64 } } } %x) {
  ...
  ctd_ifb:
    ...
    %yaa = call { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_introsort_aux_impl_f_09452478 ({ { i64, { i64, i8* } }*, { i64, { i64, i64 } } } %yd)
    %yba = sub i64 %a2b, 1
    ...
    %x13 = call { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_introsort_aux_impl_f_09452478 ({ { i64, { i64, i8* } }*, { i64, { i64, i64 } } } %x12)
    br label %ctd_ifa
...
define i64* @Sorting_Introsort_unat_sort_introsort_aux_impl_f_09433260({ i64*, { i64, { i64, i64 } } } %x) {
  ...
  ctd_ifb:
    ...
    %yaa = call i64* @Sorting_Introsort_unat_sort_introsort_aux_impl_f_09433260 ({ i64*, { i64, { i64, i64 } } } %yd)
    %yba = sub i64 %a2b, 1
    %yf2 = insertvalue { i64, i64 } zeroinitializer, i64 %a1b, 0
    %tmphb = insertvalue { i64, i64 } %yf2, i64 %yba, 1
    %yg2 = insertvalue { i64, { i64, i64 } } zeroinitializer, i64 %a2c2, 0
    ...
    %x13 = call i64* @Sorting_Introsort_unat_sort_introsort_aux_impl_f_09433260 ({ i64*, { i64, { i64, i64 } } } %x12)
    br label %ctd_ifa
