...
define void @__isabelle_llvm_par_wrapper_0_1 (i8 * %clpv) {
  ...
  %res = call i64 @LLVM_Codegen_Preproc_experiment7781868_fib (i64 %arg)
...
define void @__isabelle_llvm_par_wrapper_0_2 (i8 * %clpv) {
  ...
  %res = call i16 @LLVM_Codegen_Preproc_experiment7781868_test2 (i32 %arg)
...
define i64 @LLVM_Codegen_Preproc_experiment7781868_fib(i64 %n) {

  start:
    %x = call i64 @LLVM_Codegen_Preproc_experiment7781868_fib_f_07831674 (i64 %n)
    ret i64 %x
}

define i16 @LLVM_Codegen_Preproc_experiment7781868_test2(i32 %n) {
...
define { i64, i16 } @LLVM_Codegen_Preproc_experiment7781868_test_ppar() {
...
define i64 @LLVM_Codegen_Preproc_experiment7781868_fib_f_07831674(i64 %x) {
  ...
  then:
    ...
    %n_1 = sub i64 %x, 1
    %a = call i64 @LLVM_Codegen_Preproc_experiment7781868_fib_f_07831674 (i64 %n_1)
    %n_2 = sub i64 %x, 2
    %x1 = call i64 @LLVM_Codegen_Preproc_experiment7781868_fib_f_07831674 (i64 %n_2)
    %x2 = add i64 %a, %x1
    br label %ctd_if
