...
while_body.preheader:                             ; preds = %middle.block, %vector.memcheck, %while_body.lr.ph
  %i3.ph = phi i64 [ %n.vec, %middle.block ], [ 0, %while_body.lr.ph ], [ 0, %vector.memcheck ]
  br label %while_body
...
Sorting_Strings_strcmp_impl.exit:                 ; preds = %ctd_ifd.i, %while_end.i
...
while_body:                                       ; preds = %ctd_ifa, %while_body.lr.ph
...
thend:                                            ; preds = %while_end, %start
  %x10 = icmp slt i64 %l, %la
  br label %ctd_ifd

ctd_ifd:                                          ; preds = %thend, %while_end
  %x11 = phi i1 [ %x10, %thend ], [ false, %while_end ]
  br label %ctd_ifc

ctd_ifc:                                          ; preds = %ctd_ifd, %while_end
...
while_body.i.i.preheader:                         ; preds = %middle.block, %vector.memcheck, %while_body.lr.ph.i.i
  %i3.i.i.ph = phi i64 [ %n.vec, %middle.block ], [ 0, %while_body.lr.ph.i.i ], [ 0, %vector.memcheck ]
...
else.i.i:                                         ; preds = %while_body.i.i, %LLVM_DS_Array_arraycpy.exit.i, %middle.block
...
ctd_if:                                           ; preds = %else.i.i, %LLVM_DS_Array_arraycpy.exit.i, %start
  ...
  store i64 %lb, i64* %s.elt, align 8
...
while_body.i.preheader:                           ; preds = %middle.block, %vector.memcheck, %while_body.lr.ph.i
  %i3.i.ph = phi i64 [ %n.vec, %middle.block ], [ 0, %while_body.lr.ph.i ], [ 0, %vector.memcheck ]
  br label %while_body.i
...
else.i:                                           ; preds = %while_body.i, %LLVM_DS_Array_arraycpy.exit, %middle.block
  tail call void @isabelle_llvm_free(i8* nonnull %a)
  br label %LLVM_DS_NArray_narray_free.exit

LLVM_DS_NArray_narray_free.exit:                  ; preds = %else.i, %LLVM_DS_Array_arraycpy.exit
...
while_body.i:                                     ; preds = %while_body.i.preheader, %while_body.i
  ...
  %xca.i = tail call { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_sift_down_impl(i64 %x1, i64 %x2, i64 %xba.i, { i64, { i64, i8* } }* %x) #3
...
while_body.preheader:                             ; preds = %Sorting_Introsort_str_sort_heapify_btu_impl.exit
  %r.elt.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x, i64 %x1, i32 0
  %0 = bitcast i64* %r.elt.i to <2 x i64>*
  %r.unpack2.elt4.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x, i64 %x1, i32 1, i32 1
  %1 = bitcast i8** %r.unpack2.elt4.i to i64*
  br label %while_body

while_body:                                       ; preds = %while_body, %while_body.preheader
  %a22 = phi i64 [ %xda1, %while_body ], [ %x2, %while_body.preheader ]
  %xda1 = add nsw i64 %a22, -1
  %2 = load <2 x i64>, <2 x i64>* %0, align 8
  %r.unpack2.unpack522.i = load i64, i64* %1, align 8
  %ra.elt.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x, i64 %xda1, i32 0
  %3 = bitcast i64* %ra.elt.i to <2 x i64>*
  %4 = load <2 x i64>, <2 x i64>* %3, align 8
  %ra.unpack8.elt10.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x, i64 %xda1, i32 1, i32 1
  %5 = bitcast i8** %ra.unpack8.elt10.i to i64*
  %ra.unpack8.unpack1117.i = load i64, i64* %5, align 8
  store <2 x i64> %4, <2 x i64>* %0, align 8
  store i64 %ra.unpack8.unpack1117.i, i64* %1, align 8
  store <2 x i64> %2, <2 x i64>* %3, align 8
  store i64 %r.unpack2.unpack522.i, i64* %5, align 8
  %xg = tail call { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_sift_down_impl(i64 %x1, i64 %xda1, i64 %x1, { i64, { i64, i8* } }* %x)
...
while_body.i:                                     ; preds = %while_body.i.preheader, %Sorting_Introsort_str_sort_is_insert_impl.exit
  %a22.i = phi i64 [ %xba.i, %Sorting_Introsort_str_sort_is_insert_impl.exit ], [ %x1, %while_body.i.preheader ]
  %r.elt.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x6.i, i64 %a22.i, i32 0
  %r.unpack.i = load i64, i64* %r.elt.i, align 8
  %r.unpack2.elt.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x6.i, i64 %a22.i, i32 1, i32 0
  %r.unpack2.unpack.i = load i64, i64* %r.unpack2.elt.i, align 8
  %r.unpack2.elt4.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x6.i, i64 %a22.i, i32 1, i32 1
  %r.unpack2.unpack5.i = load i8*, i8** %r.unpack2.elt4.i, align 8
  %xda33.i = icmp sgt i64 %a22.i, %x1
  br i1 %xda33.i, label %then.i.preheader, label %Sorting_Introsort_str_sort_is_insert_impl.exit

then.i.preheader:                                 ; preds = %while_body.i
  br label %then.i

then.i:                                           ; preds = %then.i.preheader, %while_body.i3
  %a2a36.i = phi i64 [ %bib.i, %while_body.i3 ], [ %a22.i, %then.i.preheader ]
  %bib.i = add nsw i64 %a2a36.i, -1
  %ra.elt.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x6.i, i64 %bib.i, i32 0
  %0 = bitcast i64* %ra.elt.i to <2 x i64>*
  %1 = load <2 x i64>, <2 x i64>* %0, align 8
  %ra.unpack23.elt25.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x6.i, i64 %bib.i, i32 1, i32 1
  %ra.unpack23.unpack26.i = load i8*, i8** %ra.unpack23.elt25.i, align 8
  %2 = extractelement <2 x i64> %1, i32 0
  %xd.i.i = icmp sgt i64 %r.unpack.i, %2
  %la.l.i.i = select i1 %xd.i.i, i64 %2, i64 %r.unpack.i
  %xga1.i.i = icmp sgt i64 %la.l.i.i, 0
  %3 = ptrtoint i8* %ra.unpack23.unpack26.i to i64
  br i1 %xga1.i.i, label %while_body.i.i1.preheader, label %Sorting_Strings_strcmp_impl.exit.i

while_body.i.i1.preheader:                        ; preds = %then.i
  br label %while_body.i.i1

while_body.i.i1:                                  ; preds = %while_body.i.i1.preheader, %ctd_ifa.i.i
  %a12.i.i = phi i64 [ %a1.i.i, %ctd_ifa.i.i ], [ 0, %while_body.i.i1.preheader ]
  %xh.i.i = getelementptr i8, i8* %r.unpack2.unpack5.i, i64 %a12.i.i
  %xi.i.i = load i8, i8* %xh.i.i, align 1
  %xk.i.i = getelementptr i8, i8* %ra.unpack23.unpack26.i, i64 %a12.i.i
  %xl.i.i = load i8, i8* %xk.i.i, align 1
  %xm.i.i = icmp eq i8 %xi.i.i, %xl.i.i
  br i1 %xm.i.i, label %thena.i.i, label %elsea.i.i

thena.i.i:                                        ; preds = %while_body.i.i1
  %xna.i.i = add i64 %a12.i.i, 1
  %xo.i.i = insertvalue { i64, i2 } zeroinitializer, i64 %xna.i.i, 0
  %x5.i.i = insertvalue { i64, i2 } %xo.i.i, i2 0, 1
  br label %ctd_ifa.i.i

elsea.i.i:                                        ; preds = %while_body.i.i1
  %xn.i.i = icmp ult i8 %xi.i.i, %xl.i.i
  %xoa.i.i = add i64 %a12.i.i, 1
  %xp.i.i = insertvalue { i64, i2 } zeroinitializer, i64 %xoa.i.i, 0
  %x7.i.i = insertvalue { i64, i2 } %xp.i.i, i2 1, 1
  %x6.i.i = insertvalue { i64, i2 } %xp.i.i, i2 -1, 1
  %x8.i.i = select i1 %xn.i.i, { i64, i2 } %x6.i.i, { i64, i2 } %x7.i.i
  br label %ctd_ifa.i.i

ctd_ifa.i.i:                                      ; preds = %elsea.i.i, %thena.i.i
  %x9.i.i = phi { i64, i2 } [ %x5.i.i, %thena.i.i ], [ %x8.i.i, %elsea.i.i ]
  %a1.i.i = extractvalue { i64, i2 } %x9.i.i, 0
  %a2.i.i = extractvalue { i64, i2 } %x9.i.i, 1
  %xga.i.i = icmp slt i64 %a1.i.i, %la.l.i.i
  %x3.i.i2 = icmp eq i2 %a2.i.i, 0
  %x4.i.i = and i1 %xga.i.i, %x3.i.i2
  br i1 %x4.i.i, label %while_body.i.i1, label %while_end.i.i

while_end.i.i:                                    ; preds = %ctd_ifa.i.i
  switch i2 %a2.i.i, label %while_end.loopexit.i [
    i2 -1, label %while_body.i3
    i2 0, label %Sorting_Strings_strcmp_impl.exit.i
  ]

Sorting_Strings_strcmp_impl.exit.i:               ; preds = %while_end.i.i, %then.i
  %x10.i.i = icmp slt i64 %r.unpack.i, %2
  br i1 %x10.i.i, label %while_body.i3, label %while_end.loopexit.i

while_body.i3:                                    ; preds = %Sorting_Strings_strcmp_impl.exit.i, %while_end.i.i
  %p1.repack.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x6.i, i64 %a2a36.i, i32 0
  %4 = bitcast i64* %p1.repack.i to <2 x i64>*
  store <2 x i64> %1, <2 x i64>* %4, align 8
  %p1.repack17.repack19.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x6.i, i64 %a2a36.i, i32 1, i32 1
  %5 = bitcast i8** %p1.repack17.repack19.i to i64*
  store i64 %3, i64* %5, align 8
  %xda.i = icmp sgt i64 %bib.i, %x1
  br i1 %xda.i, label %then.i, label %while_end.loopexit.i

while_end.loopexit.i:                             ; preds = %while_body.i3, %Sorting_Strings_strcmp_impl.exit.i, %while_end.i.i
  %a2a.lcssa.ph.i = phi i64 [ %a2a36.i, %Sorting_Strings_strcmp_impl.exit.i ], [ %bib.i, %while_body.i3 ], [ %a2a36.i, %while_end.i.i ]
  %.pre.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x6.i, i64 %a2a.lcssa.ph.i, i32 0
  %.pre43.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x6.i, i64 %a2a.lcssa.ph.i, i32 1, i32 0
  %.pre44.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x6.i, i64 %a2a.lcssa.ph.i, i32 1, i32 1
  br label %Sorting_Introsort_str_sort_is_insert_impl.exit

Sorting_Introsort_str_sort_is_insert_impl.exit:   ; preds = %while_body.i, %while_end.loopexit.i
  %p2.repack7.repack9.pre-phi.i = phi i8** [ %.pre44.i, %while_end.loopexit.i ], [ %r.unpack2.elt4.i, %while_body.i ]
  %p2.repack7.repack.pre-phi.i = phi i64* [ %.pre43.i, %while_end.loopexit.i ], [ %r.unpack2.elt.i, %while_body.i ]
  %p2.repack.pre-phi.i = phi i64* [ %.pre.i, %while_end.loopexit.i ], [ %r.elt.i, %while_body.i ]
  store i64 %r.unpack.i, i64* %p2.repack.pre-phi.i, align 8
  store i64 %r.unpack2.unpack.i, i64* %p2.repack7.repack.pre-phi.i, align 8
  store i8* %r.unpack2.unpack5.i, i8** %p2.repack7.repack9.pre-phi.i, align 8
  %xba.i = add nsw i64 %a22.i, 1
  %exitcond.i = icmp eq i64 %xba.i, %x2
  br i1 %exitcond.i, label %ctd_if, label %while_body.i

ctd_if:                                           ; preds = %Sorting_Introsort_str_sort_is_insert_impl.exit, %Sorting_Log2_word_clz_impl.exit, %start
  %x5 = phi { i64, { i64, i8* } }* [ %x, %start ], [ %x6.i, %Sorting_Log2_word_clz_impl.exit ], [ %x6.i, %Sorting_Introsort_str_sort_is_insert_impl.exit ]
  ret { i64, { i64, i8* } }* %x5
}

; Function Attrs: norecurse nounwind
define { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_is_insert_impl({ i64, { i64, i8* } }* returned %x, i64 %x1, i64 %x2) local_unnamed_addr #0 {
start:
...
Sorting_Strings_strcmp_impl.exit:                 ; preds = %while_end.i, %then
  %x10.i = icmp slt i64 %r.unpack, %2
  br i1 %x10.i, label %while_body, label %while_end.loopexit

while_body:                                       ; preds = %Sorting_Strings_strcmp_impl.exit, %while_end.i
...
while_end.loopexit:                               ; preds = %while_body, %Sorting_Strings_strcmp_impl.exit, %while_end.i
...
; Function Attrs: norecurse nounwind
define { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_sift_down_impl(i64 %x, i64 %x1, i64 %x2, { i64, { i64, i8* } }* returned %x3) local_unnamed_addr #0 {
start:
  %x4 = sub i64 %x2, %x
...
Sorting_Strings_strcmp_impl.exit:                 ; preds = %while_end.i, %while_body
  %x10.i = icmp slt i64 %4, %5
  br i1 %x10.i, label %then, label %else

then:                                             ; preds = %Sorting_Strings_strcmp_impl.exit, %while_end.i
...
while_end.i179:                                   ; preds = %ctd_ifa.i178
  switch i2 %a2.i174, label %while_end [
    i2 -1, label %ctd_if
    i2 0, label %Sorting_Strings_strcmp_impl.exit185
  ]

Sorting_Strings_strcmp_impl.exit185:              ; preds = %while_end.i179, %then
  %x10.i180 = icmp slt i64 %r.unpack, %5
  br i1 %x10.i180, label %ctd_if, label %while_end

else:                                             ; preds = %Sorting_Strings_strcmp_impl.exit, %while_end.i
...
while_end.i143:                                   ; preds = %ctd_ifa.i142
  switch i2 %a2.i138, label %while_end [
    i2 -1, label %ctd_if
    i2 0, label %Sorting_Strings_strcmp_impl.exit149
  ]

Sorting_Strings_strcmp_impl.exit149:              ; preds = %while_end.i143, %else
  %x10.i144 = icmp slt i64 %r.unpack, %4
  br i1 %x10.i144, label %ctd_if, label %while_end

ctd_if:                                           ; preds = %while_end.i143, %Sorting_Strings_strcmp_impl.exit149, %while_end.i179, %Sorting_Strings_strcmp_impl.exit185
  %.sink = phi <2 x i64> [ %3, %Sorting_Strings_strcmp_impl.exit185 ], [ %3, %while_end.i179 ], [ %1, %Sorting_Strings_strcmp_impl.exit149 ], [ %1, %while_end.i143 ]
  %ra.unpack35.unpack38.sink = phi i8* [ %rb.unpack41.unpack44, %Sorting_Strings_strcmp_impl.exit185 ], [ %rb.unpack41.unpack44, %while_end.i179 ], [ %ra.unpack35.unpack38, %Sorting_Strings_strcmp_impl.exit149 ], [ %ra.unpack35.unpack38, %while_end.i143 ]
  %xha1.sink = phi i64 [ %xja, %Sorting_Strings_strcmp_impl.exit185 ], [ %xja, %while_end.i179 ], [ %xha1, %Sorting_Strings_strcmp_impl.exit149 ], [ %xha1, %while_end.i143 ]
  %yh1 = add i64 %a1b204, %x
  %pc1.repack = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x3, i64 %yh1, i32 0
  %6 = bitcast i64* %pc1.repack to <2 x i64>*
  store <2 x i64> %.sink, <2 x i64>* %6, align 8
  %pc1.repack65.repack67 = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x3, i64 %yh1, i32 1, i32 1
  store i8* %ra.unpack35.unpack38.sink, i8** %pc1.repack65.repack67, align 8
  %xj = icmp slt i64 %xha1.sink, %xia
  br i1 %xj, label %while_body, label %while_end

while_end:                                        ; preds = %Sorting_Strings_strcmp_impl.exit149, %while_end.i143, %Sorting_Strings_strcmp_impl.exit185, %while_end.i179, %ctd_if, %start
  %a1b.lcssa = phi i64 [ %x4, %start ], [ %a1b204, %Sorting_Strings_strcmp_impl.exit149 ], [ %a1b204, %while_end.i143 ], [ %a1b204, %Sorting_Strings_strcmp_impl.exit185 ], [ %a1b204, %while_end.i179 ], [ %xha1.sink, %ctd_if ]
  %xha2 = lshr i64 %xga, 1
...
Sorting_Strings_strcmp_impl.exit113:              ; preds = %while_end.i107, %thenc
...
thend:                                            ; preds = %Sorting_Strings_strcmp_impl.exit113, %Sorting_Strings_strcmp_impl.exit113.thread
...
elsed:                                            ; preds = %Sorting_Strings_strcmp_impl.exit113, %Sorting_Strings_strcmp_impl.exit113.thread193
...
ctd_ifc:                                          ; preds = %elsec, %elsed, %thend
...
while_body.i.preheader:                           ; preds = %then
  %xha.i = add i64 %x3, -1
  %xia.i = lshr i64 %xha.i, 1
  %xha2.i = lshr i64 %x3, 1
  br label %while_body.i

while_body.i:                                     ; preds = %Sorting_Introsort_unat_sort_sift_down_impl.exit, %while_body.i.preheader
  %x32.i = phi i64 [ %xba.i, %Sorting_Introsort_unat_sort_sift_down_impl.exit ], [ %xa.i, %while_body.i.preheader ]
  %xba.i = add i64 %x32.i, -1
  %x4.i1 = sub i64 %xba.i, %x1
  %xb.i = getelementptr i64, i64* %x, i64 %xba.i
  %r.i2 = load i64, i64* %xb.i, align 8
  %xj3.i = icmp slt i64 %x4.i1, %xia.i
  br i1 %xj3.i, label %while_body.i4.preheader, label %while_end.i

while_body.i4.preheader:                          ; preds = %while_body.i
  br label %while_body.i4

while_body.i4:                                    ; preds = %while_body.i4.preheader, %ctd_if.i
  %a1b4.i = phi i64 [ %xha1.sink.i, %ctd_if.i ], [ %x4.i1, %while_body.i4.preheader ]
  %xga1.i = shl i64 %a1b4.i, 1
  %xha1.i = or i64 %xga1.i, 1
  %xja.i = add i64 %xga1.i, 2
  %xk.i = add i64 %xha1.i, %x1
  %xl.i = add i64 %xja.i, %x1
  %xm.i = getelementptr i64, i64* %x, i64 %xk.i
  %ra.i3 = load i64, i64* %xm.i, align 8
  %xp.i = getelementptr i64, i64* %x, i64 %xl.i
  %rb.i = load i64, i64* %xp.i, align 8
  %xs.i = icmp ult i64 %ra.i3, %rb.i
  br i1 %xs.i, label %then.i, label %else.i

then.i:                                           ; preds = %while_body.i4
  %ya.i = icmp ult i64 %r.i2, %rb.i
  br i1 %ya.i, label %ctd_if.i, label %while_end.i

else.i:                                           ; preds = %while_body.i4
  %ya1.i = icmp ult i64 %r.i2, %ra.i3
  br i1 %ya1.i, label %ctd_if.i, label %while_end.i

ctd_if.i:                                         ; preds = %else.i, %then.i
  %ra.i3.sink = phi i64 [ %rb.i, %then.i ], [ %ra.i3, %else.i ]
  %xha1.sink.i = phi i64 [ %xja.i, %then.i ], [ %xha1.i, %else.i ]
  %yh1.i = add i64 %a1b4.i, %x1
  %pc1.i = getelementptr i64, i64* %x, i64 %yh1.i
  store i64 %ra.i3.sink, i64* %pc1.i, align 8
  %xj.i = icmp slt i64 %xha1.sink.i, %xia.i
  br i1 %xj.i, label %while_body.i4, label %while_end.i

while_end.i:                                      ; preds = %ctd_if.i, %else.i, %then.i, %while_body.i
  %a1b.lcssa.i = phi i64 [ %x4.i1, %while_body.i ], [ %xha1.sink.i, %ctd_if.i ], [ %a1b4.i, %then.i ], [ %a1b4.i, %else.i ]
  %xi1.i = icmp slt i64 %a1b.lcssa.i, %xha2.i
  br i1 %xi1.i, label %thenc.i, label %elsec.i

thenc.i:                                          ; preds = %while_end.i
  %xj1.i = shl i64 %a1b.lcssa.i, 1
  %xka.i = or i64 %xj1.i, 1
  %xl1.i = add i64 %xka.i, %x1
  %xm1.i = getelementptr i64, i64* %x, i64 %xl1.i
  %ra1.i = load i64, i64* %xm1.i, align 8
  %xp1.i = icmp ult i64 %r.i2, %ra1.i
  %xw2.i = add i64 %a1b.lcssa.i, %x1
  %pa1.i = getelementptr i64, i64* %x, i64 %xw2.i
  br i1 %xp1.i, label %thend.i, label %Sorting_Introsort_unat_sort_sift_down_impl.exit

thend.i:                                          ; preds = %thenc.i
  store i64 %ra1.i, i64* %pa1.i, align 8
  br label %Sorting_Introsort_unat_sort_sift_down_impl.exit

elsec.i:                                          ; preds = %while_end.i
  %xj2.i = add i64 %a1b.lcssa.i, %x1
  %p2.i = getelementptr i64, i64* %x, i64 %xj2.i
  br label %Sorting_Introsort_unat_sort_sift_down_impl.exit

Sorting_Introsort_unat_sort_sift_down_impl.exit:  ; preds = %thenc.i, %thend.i, %elsec.i
  %xm1.sink.i = phi i64* [ %xm1.i, %thend.i ], [ %p2.i, %elsec.i ], [ %pa1.i, %thenc.i ]
  store i64 %r.i2, i64* %xm1.sink.i, align 8
  %x4.i = icmp sgt i64 %xba.i, %x1
  br i1 %x4.i, label %while_body.i, label %Sorting_Introsort_unat_sort_heapify_btu_impl.exit

Sorting_Introsort_unat_sort_heapify_btu_impl.exit: ; preds = %Sorting_Introsort_unat_sort_sift_down_impl.exit, %then
  %xda = add i64 %x1, 1
  %x41 = icmp slt i64 %xda, %x2
  br i1 %x41, label %while_body.preheader, label %ctd_if

while_body.preheader:                             ; preds = %Sorting_Introsort_unat_sort_heapify_btu_impl.exit
  %x3.i = getelementptr i64, i64* %x, i64 %x1
  br label %while_body

while_body:                                       ; preds = %Sorting_Introsort_unat_sort_sift_down_impl.exit55, %while_body.preheader
  %a22 = phi i64 [ %xda1, %Sorting_Introsort_unat_sort_sift_down_impl.exit55 ], [ %x2, %while_body.preheader ]
  %xda1 = add nsw i64 %a22, -1
  %r.i = load i64, i64* %x3.i, align 8
  %xc.i = getelementptr i64, i64* %x, i64 %xda1
  %ra.i = load i64, i64* %xc.i, align 8
  store i64 %ra.i, i64* %x3.i, align 8
  store i64 %r.i, i64* %xc.i, align 8
  %r.i6 = load i64, i64* %x3.i, align 8
  %xga.i7 = sub i64 %xda1, %x1
  %xha.i8 = add i64 %xga.i7, -1
  %xia.i9 = lshr i64 %xha.i8, 1
  %xj3.i10 = icmp eq i64 %xia.i9, 0
  br i1 %xj3.i10, label %while_end.i40, label %while_body.i23.preheader

while_body.i23.preheader:                         ; preds = %while_body
  br label %while_body.i23

while_body.i23:                                   ; preds = %while_body.i23.preheader, %ctd_if.i36
  %a1b4.i12 = phi i64 [ %xha1.sink.i34, %ctd_if.i36 ], [ 0, %while_body.i23.preheader ]
  %xga1.i13 = shl i64 %a1b4.i12, 1
  %xha1.i14 = or i64 %xga1.i13, 1
  %xja.i15 = add i64 %xga1.i13, 2
  %xk.i16 = add i64 %xha1.i14, %x1
  %xl.i17 = add i64 %xja.i15, %x1
  %xm.i18 = getelementptr i64, i64* %x, i64 %xk.i16
  %ra.i19 = load i64, i64* %xm.i18, align 8
  %xp.i20 = getelementptr i64, i64* %x, i64 %xl.i17
  %rb.i21 = load i64, i64* %xp.i20, align 8
  %xs.i22 = icmp ult i64 %ra.i19, %rb.i21
  br i1 %xs.i22, label %then.i25, label %else.i30

then.i25:                                         ; preds = %while_body.i23
  %ya.i24 = icmp ult i64 %r.i6, %rb.i21
  br i1 %ya.i24, label %ctd_if.i36, label %while_end.i40

else.i30:                                         ; preds = %while_body.i23
  %ya1.i29 = icmp ult i64 %r.i6, %ra.i19
  br i1 %ya1.i29, label %ctd_if.i36, label %while_end.i40

ctd_if.i36:                                       ; preds = %else.i30, %then.i25
  %ra.i19.sink = phi i64 [ %rb.i21, %then.i25 ], [ %ra.i19, %else.i30 ]
  %xha1.sink.i34 = phi i64 [ %xja.i15, %then.i25 ], [ %xha1.i14, %else.i30 ]
  %yh1.i31 = add i64 %a1b4.i12, %x1
  %pc1.i32 = getelementptr i64, i64* %x, i64 %yh1.i31
  store i64 %ra.i19.sink, i64* %pc1.i32, align 8
  %xj.i35 = icmp slt i64 %xha1.sink.i34, %xia.i9
  br i1 %xj.i35, label %while_body.i23, label %while_end.i40

while_end.i40:                                    ; preds = %ctd_if.i36, %else.i30, %then.i25, %while_body
  %a1b.lcssa.i37 = phi i64 [ 0, %while_body ], [ %xha1.sink.i34, %ctd_if.i36 ], [ %a1b4.i12, %then.i25 ], [ %a1b4.i12, %else.i30 ]
  %xha2.i38 = lshr i64 %xga.i7, 1
  %xi1.i39 = icmp slt i64 %a1b.lcssa.i37, %xha2.i38
  br i1 %xi1.i39, label %thenc.i49, label %elsec.i53

thenc.i49:                                        ; preds = %while_end.i40
  %xj1.i41 = shl i64 %a1b.lcssa.i37, 1
  %xka.i42 = or i64 %xj1.i41, 1
  %xl1.i43 = add i64 %xka.i42, %x1
  %xm1.i44 = getelementptr i64, i64* %x, i64 %xl1.i43
  %ra1.i45 = load i64, i64* %xm1.i44, align 8
  %xp1.i46 = icmp ult i64 %r.i6, %ra1.i45
  %xw2.i47 = add i64 %a1b.lcssa.i37, %x1
  %pa1.i48 = getelementptr i64, i64* %x, i64 %xw2.i47
  br i1 %xp1.i46, label %thend.i50, label %Sorting_Introsort_unat_sort_sift_down_impl.exit55

thend.i50:                                        ; preds = %thenc.i49
  store i64 %ra1.i45, i64* %pa1.i48, align 8
  br label %Sorting_Introsort_unat_sort_sift_down_impl.exit55

elsec.i53:                                        ; preds = %while_end.i40
  %xj2.i51 = add i64 %a1b.lcssa.i37, %x1
  %p2.i52 = getelementptr i64, i64* %x, i64 %xj2.i51
  br label %Sorting_Introsort_unat_sort_sift_down_impl.exit55

Sorting_Introsort_unat_sort_sift_down_impl.exit55: ; preds = %thenc.i49, %thend.i50, %elsec.i53
  %xm1.sink.i54 = phi i64* [ %xm1.i44, %thend.i50 ], [ %p2.i52, %elsec.i53 ], [ %pa1.i48, %thenc.i49 ]
  store i64 %r.i6, i64* %xm1.sink.i54, align 8
  %x4 = icmp slt i64 %xda, %xda1
  br i1 %x4, label %while_body, label %ctd_if

ctd_if:                                           ; preds = %Sorting_Introsort_unat_sort_sift_down_impl.exit55, %Sorting_Introsort_unat_sort_heapify_btu_impl.exit, %start
  ret i64* %x
}
...
; Function Attrs: norecurse nounwind
define i64* @Sorting_Introsort_unat_sort_is_insert_impl(i64* returned %x, i64 %x1, i64 %x2) local_unnamed_addr #0 {
start:
...
while_body:                                       ; preds = %then
  ...
  %xda = icmp sgt i64 %bib, %x1
  br i1 %xda, label %then, label %while_end.loopexit.split.loop.exit

while_end.loopexit.split.loop.exit:               ; preds = %while_body
  %xea.le = getelementptr i64, i64* %x, i64 %bib
  br label %while_end

while_end:                                        ; preds = %then, %while_end.loopexit.split.loop.exit, %start
  %p2.pre-phi = phi i64* [ %x3, %start ], [ %xea.le, %while_end.loopexit.split.loop.exit ], [ %p1, %then ]
  store i64 %r, i64* %p2.pre-phi, align 8
  ret i64* %x
}

; Function Attrs: norecurse nounwind
define i64* @Sorting_Introsort_unat_sort_sift_down_impl(i64 %x, i64 %x1, i64 %x2, i64* returned %x3) local_unnamed_addr #0 {
start:
  %x4 = sub i64 %x2, %x
...
then:                                             ; preds = %while_body
  ...
  br i1 %ya, label %ctd_if, label %while_end

else:                                             ; preds = %while_body
  %ya1 = icmp ult i64 %r, %ra
  br i1 %ya1, label %ctd_if, label %while_end

ctd_if:                                           ; preds = %else, %then
  %ra.sink = phi i64 [ %rb, %then ], [ %ra, %else ]
  %xha1.sink = phi i64 [ %xja, %then ], [ %xha1, %else ]
  %yh1 = add i64 %a1b4, %x
  %pc1 = getelementptr i64, i64* %x3, i64 %yh1
  store i64 %ra.sink, i64* %pc1, align 8
  %xj = icmp slt i64 %xha1.sink, %xia
  br i1 %xj, label %while_body, label %while_end

while_end:                                        ; preds = %else, %then, %ctd_if, %start
  %a1b.lcssa = phi i64 [ %x4, %start ], [ %a1b4, %else ], [ %a1b4, %then ], [ %xha1.sink, %ctd_if ]
  %xha2 = lshr i64 %xga, 1
  %xi1 = icmp slt i64 %a1b.lcssa, %xha2
  br i1 %xi1, label %thenc, label %elsec
...
ctd_ifc:                                          ; preds = %elsec, %thend, %thenc
...
while_body:                                       ; preds = %while_body.preheader, %while_body
  ...
  %xba = add i64 %x32, -1
  %xca = tail call { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_sift_down_impl(i64 %x, i64 %x1, i64 %xba, { i64, { i64, i8* } }* %x2)
...
while_starta.preheader:                           ; preds = %Sorting_Strings_strcmp_impl.exit, %while_end.i
  br label %while_starta

Sorting_Strings_strcmp_impl.exit:                 ; preds = %while_end.i, %while_start
...
Sorting_Strings_strcmp_impl.exit191:              ; preds = %while_end.i185, %while_starta
  %x10.i186 = icmp slt i64 %ra.unpack, %ra1.unpack
  br i1 %x10.i186, label %while_starta.backedge, label %while_enda

while_starta.backedge:                            ; preds = %Sorting_Strings_strcmp_impl.exit191, %while_end.i185
  br label %while_starta

while_enda:                                       ; preds = %Sorting_Strings_strcmp_impl.exit191, %while_end.i185
...
while_bodyb:                                      ; preds = %while_bodyb.preheader, %while_endd
  ...
  store <2 x i64> %3, <2 x i64>* %0, align 8
  store i64 %r.unpack.i, i64* %ra.elt.i, align 8
  store <2 x i64> %1, <2 x i64>* %2, align 8
...
Sorting_Strings_strcmp_impl.exit155:              ; preds = %while_end.i149, %while_startc
  %x10.i150 = icmp slt i64 %r2.unpack, %ra2.unpack
  br i1 %x10.i150, label %while_startc.backedge, label %while_startd.preheader

while_startc.backedge:                            ; preds = %Sorting_Strings_strcmp_impl.exit155, %while_end.i149
  br label %while_startc

while_startd.preheader:                           ; preds = %Sorting_Strings_strcmp_impl.exit155, %while_end.i149
...
Sorting_Strings_strcmp_impl.exit119:              ; preds = %while_end.i113, %while_startd
  %x10.i114 = icmp slt i64 %ra2.unpack, %ra3.unpack
  br i1 %x10.i114, label %while_startd.backedge, label %while_endd

while_startd.backedge:                            ; preds = %Sorting_Strings_strcmp_impl.exit119, %while_end.i113
  br label %while_startd

while_endd:                                       ; preds = %Sorting_Strings_strcmp_impl.exit119, %while_end.i113
...
while_body.preheader:                             ; preds = %start
  %xga.i = sub i64 %x1, %x
  %xha.i = add i64 %xga.i, -1
  %xia.i = lshr i64 %xha.i, 1
  %xha2.i = lshr i64 %xga.i, 1
  br label %while_body

while_body:                                       ; preds = %Sorting_Introsort_unat_sort_sift_down_impl.exit, %while_body.preheader
  %x32 = phi i64 [ %xba, %Sorting_Introsort_unat_sort_sift_down_impl.exit ], [ %xa, %while_body.preheader ]
  %xba = add i64 %x32, -1
  %x4.i = sub i64 %xba, %x
  %xb.i = getelementptr i64, i64* %x2, i64 %xba
  %r.i = load i64, i64* %xb.i, align 8
  %xj3.i = icmp slt i64 %x4.i, %xia.i
  br i1 %xj3.i, label %while_body.i.preheader, label %while_end.i

while_body.i.preheader:                           ; preds = %while_body
  br label %while_body.i

while_body.i:                                     ; preds = %while_body.i.preheader, %ctd_if.i
  %a1b4.i = phi i64 [ %xha1.sink.i, %ctd_if.i ], [ %x4.i, %while_body.i.preheader ]
  %xga1.i = shl i64 %a1b4.i, 1
  %xha1.i = or i64 %xga1.i, 1
  %xja.i = add i64 %xga1.i, 2
  %xk.i = add i64 %xha1.i, %x
  %xl.i = add i64 %xja.i, %x
  %xm.i = getelementptr i64, i64* %x2, i64 %xk.i
  %ra.i = load i64, i64* %xm.i, align 8
  %xp.i = getelementptr i64, i64* %x2, i64 %xl.i
  %rb.i = load i64, i64* %xp.i, align 8
  %xs.i = icmp ult i64 %ra.i, %rb.i
  br i1 %xs.i, label %then.i, label %else.i

then.i:                                           ; preds = %while_body.i
  %ya.i = icmp ult i64 %r.i, %rb.i
  br i1 %ya.i, label %ctd_if.i, label %while_end.i

else.i:                                           ; preds = %while_body.i
  %ya1.i = icmp ult i64 %r.i, %ra.i
  br i1 %ya1.i, label %ctd_if.i, label %while_end.i

ctd_if.i:                                         ; preds = %else.i, %then.i
  %ra.i.sink = phi i64 [ %rb.i, %then.i ], [ %ra.i, %else.i ]
  %xha1.sink.i = phi i64 [ %xja.i, %then.i ], [ %xha1.i, %else.i ]
  %yh1.i = add i64 %a1b4.i, %x
  %pc1.i = getelementptr i64, i64* %x2, i64 %yh1.i
  store i64 %ra.i.sink, i64* %pc1.i, align 8
  %xj.i = icmp slt i64 %xha1.sink.i, %xia.i
  br i1 %xj.i, label %while_body.i, label %while_end.i

while_end.i:                                      ; preds = %ctd_if.i, %else.i, %then.i, %while_body
  %a1b.lcssa.i = phi i64 [ %x4.i, %while_body ], [ %xha1.sink.i, %ctd_if.i ], [ %a1b4.i, %then.i ], [ %a1b4.i, %else.i ]
  %xi1.i = icmp slt i64 %a1b.lcssa.i, %xha2.i
  br i1 %xi1.i, label %thenc.i, label %elsec.i
...
thenc.i:                                          ; preds = %while_end.i
  %xj1.i = shl i64 %a1b.lcssa.i, 1
  %xka.i = or i64 %xj1.i, 1
  %xl1.i = add i64 %xka.i, %x
  %xm1.i = getelementptr i64, i64* %x2, i64 %xl1.i
  %ra1.i = load i64, i64* %xm1.i, align 8
  %xp1.i = icmp ult i64 %r.i, %ra1.i
  %xw2.i = add i64 %a1b.lcssa.i, %x
  %pa1.i = getelementptr i64, i64* %x2, i64 %xw2.i
  br i1 %xp1.i, label %thend.i, label %Sorting_Introsort_unat_sort_sift_down_impl.exit
...
elsec.i:                                          ; preds = %while_end.i
  %xj2.i = add i64 %a1b.lcssa.i, %x
  %p2.i = getelementptr i64, i64* %x2, i64 %xj2.i
  br label %Sorting_Introsort_unat_sort_sift_down_impl.exit

Sorting_Introsort_unat_sort_sift_down_impl.exit:  ; preds = %thenc.i, %thend.i, %elsec.i
  %xm1.sink.i = phi i64* [ %xm1.i, %thend.i ], [ %p2.i, %elsec.i ], [ %pa1.i, %thenc.i ]
  store i64 %r.i, i64* %xm1.sink.i, align 8
  %x4 = icmp sgt i64 %xba, %x
  br i1 %x4, label %while_body, label %while_end

while_end:                                        ; preds = %Sorting_Introsort_unat_sort_sift_down_impl.exit, %start
  ret i64* %x2
}
...
while_body:                                       ; preds = %while_body.preheader, %Sorting_Introsort_str_sort_is_insert_impl.exit
  %a22 = phi i64 [ %xba, %Sorting_Introsort_str_sort_is_insert_impl.exit ], [ %x1, %while_body.preheader ]
  %r.elt.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x, i64 %a22, i32 0
  %r.unpack.i = load i64, i64* %r.elt.i, align 8
  %r.unpack2.elt.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x, i64 %a22, i32 1, i32 0
  %r.unpack2.unpack.i = load i64, i64* %r.unpack2.elt.i, align 8
  %r.unpack2.elt4.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x, i64 %a22, i32 1, i32 1
  %r.unpack2.unpack5.i = load i8*, i8** %r.unpack2.elt4.i, align 8
  %xda33.i = icmp sgt i64 %a22, %x1
  br i1 %xda33.i, label %then.i.preheader, label %Sorting_Introsort_str_sort_is_insert_impl.exit
...
then.i:                                           ; preds = %then.i.preheader, %while_body.i
  %a2a36.i = phi i64 [ %bib.i, %while_body.i ], [ %a22, %then.i.preheader ]
  %bib.i = add nsw i64 %a2a36.i, -1
  %ra.elt.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x, i64 %bib.i, i32 0
  %0 = bitcast i64* %ra.elt.i to <2 x i64>*
  %1 = load <2 x i64>, <2 x i64>* %0, align 8
  %ra.unpack23.elt25.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x, i64 %bib.i, i32 1, i32 1
  %ra.unpack23.unpack26.i = load i8*, i8** %ra.unpack23.elt25.i, align 8
  %2 = extractelement <2 x i64> %1, i32 0
  %xd.i.i = icmp sgt i64 %r.unpack.i, %2
  %la.l.i.i = select i1 %xd.i.i, i64 %2, i64 %r.unpack.i
  %xga1.i.i = icmp sgt i64 %la.l.i.i, 0
  %3 = ptrtoint i8* %ra.unpack23.unpack26.i to i64
  br i1 %xga1.i.i, label %while_body.i.i.preheader, label %Sorting_Strings_strcmp_impl.exit.i

while_body.i.i.preheader:                         ; preds = %then.i
  br label %while_body.i.i

while_body.i.i:                                   ; preds = %while_body.i.i.preheader, %ctd_ifa.i.i
  %a12.i.i = phi i64 [ %a1.i.i, %ctd_ifa.i.i ], [ 0, %while_body.i.i.preheader ]
  %xh.i.i = getelementptr i8, i8* %r.unpack2.unpack5.i, i64 %a12.i.i
  %xi.i.i = load i8, i8* %xh.i.i, align 1
  %xk.i.i = getelementptr i8, i8* %ra.unpack23.unpack26.i, i64 %a12.i.i
  %xl.i.i = load i8, i8* %xk.i.i, align 1
...
thena.i.i:                                        ; preds = %while_body.i.i
  %xna.i.i = add i64 %a12.i.i, 1
  %xo.i.i = insertvalue { i64, i2 } zeroinitializer, i64 %xna.i.i, 0
  %x5.i.i = insertvalue { i64, i2 } %xo.i.i, i2 0, 1
  br label %ctd_ifa.i.i

elsea.i.i:                                        ; preds = %while_body.i.i
  %xn.i.i = icmp ult i8 %xi.i.i, %xl.i.i
  %xoa.i.i = add i64 %a12.i.i, 1
  %xp.i.i = insertvalue { i64, i2 } zeroinitializer, i64 %xoa.i.i, 0
  %x7.i.i = insertvalue { i64, i2 } %xp.i.i, i2 1, 1
...
ctd_ifa.i.i:                                      ; preds = %elsea.i.i, %thena.i.i
  ...
  %a2.i.i = extractvalue { i64, i2 } %x9.i.i, 1
  %xga.i.i = icmp slt i64 %a1.i.i, %la.l.i.i
  %x3.i.i = icmp eq i2 %a2.i.i, 0
  %x4.i.i = and i1 %xga.i.i, %x3.i.i
  br i1 %x4.i.i, label %while_body.i.i, label %while_end.i.i

while_end.i.i:                                    ; preds = %ctd_ifa.i.i
  switch i2 %a2.i.i, label %while_end.loopexit.i [
    i2 -1, label %while_body.i
    i2 0, label %Sorting_Strings_strcmp_impl.exit.i
  ]

Sorting_Strings_strcmp_impl.exit.i:               ; preds = %while_end.i.i, %then.i
  %x10.i.i = icmp slt i64 %r.unpack.i, %2
  br i1 %x10.i.i, label %while_body.i, label %while_end.loopexit.i

while_body.i:                                     ; preds = %Sorting_Strings_strcmp_impl.exit.i, %while_end.i.i
  %p1.repack.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x, i64 %a2a36.i, i32 0
  %4 = bitcast i64* %p1.repack.i to <2 x i64>*
  store <2 x i64> %1, <2 x i64>* %4, align 8
  %p1.repack17.repack19.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x, i64 %a2a36.i, i32 1, i32 1
  %5 = bitcast i8** %p1.repack17.repack19.i to i64*
  store i64 %3, i64* %5, align 8
  %xda.i = icmp sgt i64 %bib.i, %x1
  br i1 %xda.i, label %then.i, label %while_end.loopexit.i

while_end.loopexit.i:                             ; preds = %while_body.i, %Sorting_Strings_strcmp_impl.exit.i, %while_end.i.i
  %a2a.lcssa.ph.i = phi i64 [ %a2a36.i, %Sorting_Strings_strcmp_impl.exit.i ], [ %bib.i, %while_body.i ], [ %a2a36.i, %while_end.i.i ]
  %.pre.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x, i64 %a2a.lcssa.ph.i, i32 0
  %.pre43.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x, i64 %a2a.lcssa.ph.i, i32 1, i32 0
  %.pre44.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %x, i64 %a2a.lcssa.ph.i, i32 1, i32 1
  br label %Sorting_Introsort_str_sort_is_insert_impl.exit

Sorting_Introsort_str_sort_is_insert_impl.exit:   ; preds = %while_body, %while_end.loopexit.i
  %p2.repack7.repack9.pre-phi.i = phi i8** [ %.pre44.i, %while_end.loopexit.i ], [ %r.unpack2.elt4.i, %while_body ]
  %p2.repack7.repack.pre-phi.i = phi i64* [ %.pre43.i, %while_end.loopexit.i ], [ %r.unpack2.elt.i, %while_body ]
  %p2.repack.pre-phi.i = phi i64* [ %.pre.i, %while_end.loopexit.i ], [ %r.elt.i, %while_body ]
  store i64 %r.unpack.i, i64* %p2.repack.pre-phi.i, align 8
  store i64 %r.unpack2.unpack.i, i64* %p2.repack7.repack.pre-phi.i, align 8
  store i8* %r.unpack2.unpack5.i, i8** %p2.repack7.repack9.pre-phi.i, align 8
...
while_end:                                        ; preds = %Sorting_Introsort_str_sort_is_insert_impl.exit, %start
  ret { i64, { i64, i8* } }* %x
}

; Function Attrs: norecurse nounwind
define i64* @insertion_sort(i64* returned %x, i64 %x1, i64 %x2) local_unnamed_addr #0 {
start:
...
while_body:                                       ; preds = %else, %start
  %a1b15 = phi i64 [ %x1, %start ], [ %s1, %else ]
  %a1a14 = phi i64 [ %x, %start ], [ %x6, %else ]
...
Sorting_Strings_strcmp_impl.exit:                 ; preds = %while_end.i, %thena
  %x10.i = icmp slt i64 %r.unpack, %ra.unpack
  br i1 %x10.i, label %thenb, label %elseb

thenb:                                            ; preds = %Sorting_Strings_strcmp_impl.exit, %while_end.i
...
Sorting_Strings_strcmp_impl.exit124:              ; preds = %while_end.i118, %thenb
  %x10.i119 = icmp slt i64 %ra.unpack, %4
  br i1 %x10.i119, label %thenc, label %elsec

thenc:                                            ; preds = %Sorting_Strings_strcmp_impl.exit124, %while_end.i118
...
elsec:                                            ; preds = %Sorting_Strings_strcmp_impl.exit124, %while_end.i118
...
Sorting_Strings_strcmp_impl.exit165:              ; preds = %while_end.i159, %elsec
  %x10.i160 = icmp slt i64 %r.unpack, %4
  br i1 %x10.i160, label %thend, label %elsed

thend:                                            ; preds = %Sorting_Strings_strcmp_impl.exit165, %while_end.i159
  ...
  store <2 x i64> %11, <2 x i64>* %2, align 8
  br label %ctd_ifb

elsed:                                            ; preds = %Sorting_Strings_strcmp_impl.exit165, %while_end.i159
...
elseb:                                            ; preds = %Sorting_Strings_strcmp_impl.exit, %while_end.i
  ...
  %xd.i262 = icmp sgt i64 %r.unpack, %19
  %la.l.i263 = select i1 %xd.i262, i64 %19, i64 %r.unpack
  %xga1.i264 = icmp sgt i64 %la.l.i263, 0
  %20 = ptrtoint i8* %rc1.unpack28.unpack31 to i64
...
Sorting_Strings_strcmp_impl.exit297:              ; preds = %while_end.i291, %elseb
  %x10.i292 = icmp slt i64 %r.unpack, %19
  br i1 %x10.i292, label %thene, label %elsee

thene:                                            ; preds = %Sorting_Strings_strcmp_impl.exit297, %while_end.i291
  ...
  %21 = bitcast i64* %r.elt.i250 to <2 x i64>*
  ...
  %23 = bitcast i8** %r.unpack2.elt4.i254 to i64*
  %r.unpack2.unpack522.i255 = load i64, i64* %23, align 8
  store i64 %r.unpack, i64* %r.elt.i250, align 8
  store i64 %r.unpack2.unpack, i64* %r.unpack2.elt.i252, align 8
  store i64 %1, i64* %23, align 8
  %24 = bitcast i64* %r.elt to <2 x i64>*
  store <2 x i64> %22, <2 x i64>* %24, align 8
  br label %ctd_ifb

elsee:                                            ; preds = %Sorting_Strings_strcmp_impl.exit297, %while_end.i291
  %xd.i214 = icmp sgt i64 %ra.unpack, %19
  %la.l.i215 = select i1 %xd.i214, i64 %19, i64 %ra.unpack
...
Sorting_Strings_strcmp_impl.exit249:              ; preds = %while_end.i243, %elsee
  %x10.i244 = icmp slt i64 %ra.unpack, %19
  br i1 %x10.i244, label %thenf, label %elsef

thenf:                                            ; preds = %Sorting_Strings_strcmp_impl.exit249, %while_end.i243
  %r.elt.i202 = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %a1316, i64 %a1a319, i32 0
  %25 = bitcast i64* %r.elt.i202 to <2 x i64>*
  ...
  %27 = bitcast i8** %r.unpack2.elt4.i206 to i64*
  %r.unpack2.unpack522.i207 = load i64, i64* %27, align 8
  store <2 x i64> %18, <2 x i64>* %25, align 8
  store i64 %20, i64* %27, align 8
  store <2 x i64> %26, <2 x i64>* %17, align 8
  br label %ctd_ifb

elsef:                                            ; preds = %Sorting_Strings_strcmp_impl.exit249, %while_end.i243
  ...
  %28 = bitcast i64* %r.elt.i190 to <2 x i64>*
  ...
  %30 = bitcast i8** %r.unpack2.elt4.i194 to i64*
  %r.unpack2.unpack522.i195 = load i64, i64* %30, align 8
  store i64 %ra.unpack, i64* %r.elt.i190, align 8
  store i64 %ra.unpack8.unpack, i64* %r.unpack2.elt.i192, align 8
  store i64 %0, i64* %30, align 8
  %31 = bitcast i64* %ra.elt to <2 x i64>*
  store <2 x i64> %29, <2 x i64>* %31, align 8
  br label %ctd_ifb

ctd_ifb:                                          ; preds = %elsef, %thenf, %thene, %elsed, %thend, %thenc
...
then.i:                                           ; preds = %then
  %x41.i.i = icmp sgt i64 %xja, %a1a319
...
while_body.i.i:                                   ; preds = %while_body.i.i.preheader, %while_body.i.i
  %x32.i.i = phi i64 [ %xba.i.i, %while_body.i.i ], [ %xja, %while_body.i.i.preheader ]
  %xba.i.i = add i64 %x32.i.i, -1
  %xca.i.i = tail call { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_sift_down_impl(i64 %a1a319, i64 %a1b312, i64 %xba.i.i, { i64, { i64, i8* } }* %a1316) #3
...
while_body.i128.preheader:                        ; preds = %Sorting_Introsort_str_sort_heapify_btu_impl.exit.i
  %r.elt.i.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %a1316, i64 %a1a319, i32 0
  %32 = bitcast i64* %r.elt.i.i to <2 x i64>*
  %r.unpack2.elt4.i.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %a1316, i64 %a1a319, i32 1, i32 1
  %33 = bitcast i8** %r.unpack2.elt4.i.i to i64*
  br label %while_body.i128

while_body.i128:                                  ; preds = %while_body.i128, %while_body.i128.preheader
  %a22.i = phi i64 [ %xda1.i, %while_body.i128 ], [ %a1b312, %while_body.i128.preheader ]
  %xda1.i = add nsw i64 %a22.i, -1
  %34 = load <2 x i64>, <2 x i64>* %32, align 8
  %r.unpack2.unpack522.i.i = load i64, i64* %33, align 8
  %ra.elt.i.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %a1316, i64 %xda1.i, i32 0
  %35 = bitcast i64* %ra.elt.i.i to <2 x i64>*
  %36 = load <2 x i64>, <2 x i64>* %35, align 8
  %ra.unpack8.elt10.i.i = getelementptr inbounds { i64, { i64, i8* } }, { i64, { i64, i8* } }* %a1316, i64 %xda1.i, i32 1, i32 1
  %37 = bitcast i8** %ra.unpack8.elt10.i.i to i64*
  %ra.unpack8.unpack1117.i.i = load i64, i64* %37, align 8
  store <2 x i64> %36, <2 x i64>* %32, align 8
  store i64 %ra.unpack8.unpack1117.i.i, i64* %33, align 8
  store <2 x i64> %34, <2 x i64>* %35, align 8
  store i64 %r.unpack2.unpack522.i.i, i64* %37, align 8
  %xg.i = tail call { i64, { i64, i8* } }* @Sorting_Introsort_str_sort_sift_down_impl(i64 %a1a319, i64 %xda1.i, i64 %a1a319, { i64, { i64, i8* } }* %a1316) #3
  %x4.i127 = icmp slt i64 %xda.i, %xda1.i
  br i1 %x4.i127, label %while_body.i128, label %ctd_if

ctd_if:                                           ; preds = %ctd_ifb, %while_body.i128, %Sorting_Introsort_str_sort_heapify_btu_impl.exit.i, %start
  %x15 = phi { i64, { i64, i8* } }* [ %a1316, %Sorting_Introsort_str_sort_heapify_btu_impl.exit.i ], [ %a1308, %start ], [ %a1316, %while_body.i128 ], [ %yaa, %ctd_ifb ]
  ret { i64, { i64, i8* } }* %x15
}
...
then:                                             ; preds = %Sorting_Introsort_unat_sort_qs_partition_impl.exit, %then.lr.ph
...
then.i:                                           ; preds = %then
  %x41.i.i = icmp sgt i64 %xja, %a1a44
  br i1 %x41.i.i, label %while_body.i.i.preheader, label %Sorting_Introsort_unat_sort_heapify_btu_impl.exit.i

while_body.i.i.preheader:                         ; preds = %then.i
  %xga.i10 = sub i64 %a1b39, %a1a44
  %xha.i11 = add i64 %xga.i10, -1
  %xia.i12 = lshr i64 %xha.i11, 1
  %xha2.i41 = lshr i64 %xga.i10, 1
  br label %while_body.i.i

while_body.i.i:                                   ; preds = %Sorting_Introsort_unat_sort_sift_down_impl.exit58, %while_body.i.i.preheader
  %x32.i.i = phi i64 [ %xba.i.i, %Sorting_Introsort_unat_sort_sift_down_impl.exit58 ], [ %xja, %while_body.i.i.preheader ]
  %xba.i.i = add i64 %x32.i.i, -1
  %x4.i7 = sub i64 %xba.i.i, %a1a44
  %xb.i8 = getelementptr i64, i64* %a143, i64 %xba.i.i
  %r.i9 = load i64, i64* %xb.i8, align 8
  %xj3.i13 = icmp slt i64 %x4.i7, %xia.i12
  br i1 %xj3.i13, label %while_body.i26.preheader, label %while_end.i43

while_body.i26.preheader:                         ; preds = %while_body.i.i
  br label %while_body.i26

while_body.i26:                                   ; preds = %while_body.i26.preheader, %ctd_if.i39
  %a1b4.i15 = phi i64 [ %xha1.sink.i37, %ctd_if.i39 ], [ %x4.i7, %while_body.i26.preheader ]
  %xga1.i16 = shl i64 %a1b4.i15, 1
  %xha1.i17 = or i64 %xga1.i16, 1
  %xja.i18 = add i64 %xga1.i16, 2
  %xk.i19 = add i64 %xha1.i17, %a1a44
  %xl.i20 = add i64 %xja.i18, %a1a44
  %xm.i21 = getelementptr i64, i64* %a143, i64 %xk.i19
  %ra.i22 = load i64, i64* %xm.i21, align 8
  %xp.i23 = getelementptr i64, i64* %a143, i64 %xl.i20
  %rb.i24 = load i64, i64* %xp.i23, align 8
  %xs.i25 = icmp ult i64 %ra.i22, %rb.i24
  br i1 %xs.i25, label %then.i28, label %else.i33

then.i28:                                         ; preds = %while_body.i26
  %ya.i27 = icmp ult i64 %r.i9, %rb.i24
  br i1 %ya.i27, label %ctd_if.i39, label %while_end.i43

else.i33:                                         ; preds = %while_body.i26
  %ya1.i32 = icmp ult i64 %r.i9, %ra.i22
  br i1 %ya1.i32, label %ctd_if.i39, label %while_end.i43

ctd_if.i39:                                       ; preds = %else.i33, %then.i28
  %ra.i22.sink = phi i64 [ %rb.i24, %then.i28 ], [ %ra.i22, %else.i33 ]
  %xha1.sink.i37 = phi i64 [ %xja.i18, %then.i28 ], [ %xha1.i17, %else.i33 ]
  %yh1.i34 = add i64 %a1b4.i15, %a1a44
  %pc1.i35 = getelementptr i64, i64* %a143, i64 %yh1.i34
  store i64 %ra.i22.sink, i64* %pc1.i35, align 8
  %xj.i38 = icmp slt i64 %xha1.sink.i37, %xia.i12
  br i1 %xj.i38, label %while_body.i26, label %while_end.i43

while_end.i43:                                    ; preds = %ctd_if.i39, %else.i33, %then.i28, %while_body.i.i
  %a1b.lcssa.i40 = phi i64 [ %x4.i7, %while_body.i.i ], [ %xha1.sink.i37, %ctd_if.i39 ], [ %a1b4.i15, %then.i28 ], [ %a1b4.i15, %else.i33 ]
  %xi1.i42 = icmp slt i64 %a1b.lcssa.i40, %xha2.i41
  br i1 %xi1.i42, label %thenc.i52, label %elsec.i56

thenc.i52:                                        ; preds = %while_end.i43
  %xj1.i44 = shl i64 %a1b.lcssa.i40, 1
  %xka.i45 = or i64 %xj1.i44, 1
  %xl1.i46 = add i64 %xka.i45, %a1a44
  %xm1.i47 = getelementptr i64, i64* %a143, i64 %xl1.i46
  %ra1.i48 = load i64, i64* %xm1.i47, align 8
  %xp1.i49 = icmp ult i64 %r.i9, %ra1.i48
  %xw2.i50 = add i64 %a1b.lcssa.i40, %a1a44
  %pa1.i51 = getelementptr i64, i64* %a143, i64 %xw2.i50
  br i1 %xp1.i49, label %thend.i53, label %Sorting_Introsort_unat_sort_sift_down_impl.exit58

thend.i53:                                        ; preds = %thenc.i52
  store i64 %ra1.i48, i64* %pa1.i51, align 8
  br label %Sorting_Introsort_unat_sort_sift_down_impl.exit58

elsec.i56:                                        ; preds = %while_end.i43
  %xj2.i54 = add i64 %a1b.lcssa.i40, %a1a44
  %p2.i55 = getelementptr i64, i64* %a143, i64 %xj2.i54
  br label %Sorting_Introsort_unat_sort_sift_down_impl.exit58

Sorting_Introsort_unat_sort_sift_down_impl.exit58: ; preds = %thenc.i52, %thend.i53, %elsec.i56
  %xm1.sink.i57 = phi i64* [ %xm1.i47, %thend.i53 ], [ %p2.i55, %elsec.i56 ], [ %pa1.i51, %thenc.i52 ]
  store i64 %r.i9, i64* %xm1.sink.i57, align 8
...
Sorting_Introsort_unat_sort_heapify_btu_impl.exit.i: ; preds = %Sorting_Introsort_unat_sort_sift_down_impl.exit58, %then.i
...
while_body.i.preheader:                           ; preds = %Sorting_Introsort_unat_sort_heapify_btu_impl.exit.i
  %x3.i.i = getelementptr i64, i64* %a143, i64 %a1a44
  br label %while_body.i

while_body.i:                                     ; preds = %Sorting_Introsort_unat_sort_sift_down_impl.exit, %while_body.i.preheader
  %a22.i = phi i64 [ %xda1.i, %Sorting_Introsort_unat_sort_sift_down_impl.exit ], [ %a1b39, %while_body.i.preheader ]
  %xda1.i = add nsw i64 %a22.i, -1
  %r.i.i = load i64, i64* %x3.i.i, align 8
  %xc.i.i = getelementptr i64, i64* %a143, i64 %xda1.i
  %ra.i.i = load i64, i64* %xc.i.i, align 8
  store i64 %ra.i.i, i64* %x3.i.i, align 8
  store i64 %r.i.i, i64* %xc.i.i, align 8
  %r.i1 = load i64, i64* %x3.i.i, align 8
  %xga.i = sub i64 %xda1.i, %a1a44
  %xha.i = add i64 %xga.i, -1
  %xia.i = lshr i64 %xha.i, 1
  %xj3.i = icmp eq i64 %xia.i, 0
  br i1 %xj3.i, label %while_end.i, label %while_body.i3.preheader

while_body.i3.preheader:                          ; preds = %while_body.i
  br label %while_body.i3

while_body.i3:                                    ; preds = %while_body.i3.preheader, %ctd_if.i
  %a1b4.i = phi i64 [ %xha1.sink.i, %ctd_if.i ], [ 0, %while_body.i3.preheader ]
  %xga1.i = shl i64 %a1b4.i, 1
  %xha1.i = or i64 %xga1.i, 1
  %xja.i = add i64 %xga1.i, 2
  %xk.i = add i64 %xha1.i, %a1a44
  %xl.i = add i64 %xja.i, %a1a44
  %xm.i2 = getelementptr i64, i64* %a143, i64 %xk.i
  %ra.i = load i64, i64* %xm.i2, align 8
  %xp.i = getelementptr i64, i64* %a143, i64 %xl.i
  %rb.i = load i64, i64* %xp.i, align 8
  %xs.i = icmp ult i64 %ra.i, %rb.i
  br i1 %xs.i, label %then.i4, label %else.i

then.i4:                                          ; preds = %while_body.i3
  %ya.i = icmp ult i64 %r.i1, %rb.i
  br i1 %ya.i, label %ctd_if.i, label %while_end.i

else.i:                                           ; preds = %while_body.i3
  %ya1.i = icmp ult i64 %r.i1, %ra.i
  br i1 %ya1.i, label %ctd_if.i, label %while_end.i

ctd_if.i:                                         ; preds = %else.i, %then.i4
  %ra.i.sink = phi i64 [ %rb.i, %then.i4 ], [ %ra.i, %else.i ]
  %xha1.sink.i = phi i64 [ %xja.i, %then.i4 ], [ %xha1.i, %else.i ]
  %yh1.i = add i64 %a1b4.i, %a1a44
  %pc1.i = getelementptr i64, i64* %a143, i64 %yh1.i
  store i64 %ra.i.sink, i64* %pc1.i, align 8
  %xj.i = icmp slt i64 %xha1.sink.i, %xia.i
  br i1 %xj.i, label %while_body.i3, label %while_end.i

while_end.i:                                      ; preds = %ctd_if.i, %else.i, %then.i4, %while_body.i
  %a1b.lcssa.i = phi i64 [ 0, %while_body.i ], [ %xha1.sink.i, %ctd_if.i ], [ %a1b4.i, %then.i4 ], [ %a1b4.i, %else.i ]
  %xha2.i = lshr i64 %xga.i, 1
  %xi1.i = icmp slt i64 %a1b.lcssa.i, %xha2.i
  br i1 %xi1.i, label %thenc.i, label %elsec.i
...
thenc.i:                                          ; preds = %while_end.i
  %xj1.i = shl i64 %a1b.lcssa.i, 1
  %xka.i = or i64 %xj1.i, 1
  %xl1.i5 = add i64 %xka.i, %a1a44
  %xm1.i = getelementptr i64, i64* %a143, i64 %xl1.i5
  %ra1.i6 = load i64, i64* %xm1.i, align 8
  %xp1.i = icmp ult i64 %r.i1, %ra1.i6
  %xw2.i = add i64 %a1b.lcssa.i, %a1a44
  %pa1.i = getelementptr i64, i64* %a143, i64 %xw2.i
  br i1 %xp1.i, label %thend.i, label %Sorting_Introsort_unat_sort_sift_down_impl.exit

thend.i:                                          ; preds = %thenc.i
  store i64 %ra1.i6, i64* %pa1.i, align 8
  br label %Sorting_Introsort_unat_sort_sift_down_impl.exit

elsec.i:                                          ; preds = %while_end.i
  %xj2.i = add i64 %a1b.lcssa.i, %a1a44
  %p2.i = getelementptr i64, i64* %a143, i64 %xj2.i
  br label %Sorting_Introsort_unat_sort_sift_down_impl.exit

Sorting_Introsort_unat_sort_sift_down_impl.exit:  ; preds = %thenc.i, %thend.i, %elsec.i
  %xm1.sink.i = phi i64* [ %xm1.i, %thend.i ], [ %p2.i, %elsec.i ], [ %pa1.i, %thenc.i ]
  store i64 %r.i1, i64* %xm1.sink.i, align 8
  %x4.i = icmp slt i64 %xda.i, %xda1.i
  br i1 %x4.i, label %while_body.i, label %ctd_if

ctd_if:                                           ; preds = %Sorting_Introsort_unat_sort_qs_partition_impl.exit, %Sorting_Introsort_unat_sort_sift_down_impl.exit, %Sorting_Introsort_unat_sort_heapify_btu_impl.exit.i, %start
  %x15 = phi i64* [ %a143, %Sorting_Introsort_unat_sort_heapify_btu_impl.exit.i ], [ %a135, %start ], [ %a143, %Sorting_Introsort_unat_sort_sift_down_impl.exit ], [ %yaa, %Sorting_Introsort_unat_sort_qs_partition_impl.exit ]
  ret i64* %x15
}
