...
\begin{frame}{Some Highlights}
  \begin{itemize}
   \item Isa-SAT: verified SAT Solver
   \item (Sequential) sorting algorithm: on par with Boost pdqsort / GNU's std::sort
   \item GRAT-toolchain: verified UNSAT verifier (faster than drat-trim)
