...
define { i64, { i64, i64* } } @IICF_Impl_Heap_h_sink_impl({ i64, { i64, i64* } } %x, i64 %x1) {
  ...
  start:
    ...
    %x4 = call { i64, { i64, i64* } } @IICF_Impl_Heap_h_sink_impl_f_010186222 ({ { i64, { i64, i64* } }, i64 } %x3)
    ret { i64, { i64, i64* } } %x4
}
...
define { i64, { i64, i64* } } @IICF_Impl_Heap_h_swim_impl({ i64, { i64, i64* } } %x, i64 %x1) {
  ...
  start:
    %x2 = insertvalue { { i64, { i64, i64* } }, i64 } zeroinitializer, { i64, { i64, i64* } } %x, 0
    %x3 = insertvalue { { i64, { i64, i64* } }, i64 } %x2, i64 %x1, 1
    %x4 = call { i64, { i64, i64* } } @IICF_Impl_Heap_h_swim_impl_f_010192374 ({ { i64, { i64, i64* } }, i64 } %x3)
    ret { i64, { i64, i64* } } %x4
}
...
define { i64, { i64, i64* } } @IICF_Impl_Heap_h_sink_impl_f_010186222({ { i64, { i64, i64* } }, i64 } %x) {
...
define { i64, { i64, i64* } } @IICF_Impl_Heap_h_swim_impl_f_010192374({ { i64, { i64, i64* } }, i64 } %x) {
  ...
  thena:
    ...
    %x2 = call { i64, { i64, i64* } } @IICF_Impl_Heap_h_swim_impl_f_010192374 ({ { i64, { i64, i64* } }, i64 } %x1)
    br label %ctd_ifa
