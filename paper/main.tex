...
It consists of a code generator that generates LLVM text from 
...
\end{lstlisting}
This produces an Isabelle-LLVM program \q{\is{bs_impl}}, exports it to actual LLVM text, and proves the refinement theorem
\begin{lstlisting}
