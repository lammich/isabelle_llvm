...
% #[t] Motivation: Fast and Verified Algorithms
%
%   *<1-> Collection Framework \uncover<2->{(purely functional DS)}
%     \only<1>{
%     * efficient purely functional data structures
%     * faster than ad-hoc list based
%     }
%   *<3-> Refinement Framework \uncover<4->{(separate algo and impl)}
%     \only<3>{
%     * separation of algorithmic idea and implementation
%     * allows for verification of complex algorithms
%     * originally: purely functional
%     }
%   *<5-> Sepref Tool \uncover<6->{(imperative)}
%     \only<5>{
%     * Imperative HOL backend for Refinement Framework
%     * imperative data structures
%     * significantly faster than purely functional
%     }
%   *<7-> But: cannot reach speed of C implementations yet
%     \only<7>{
%     * functional language (SML)
%     * arbitrary precision integers
%     }
%   *<9-> This paper:
%     * semantics, VCG, and code generator for LLVM
%     * LLVM backend for Refinement Framework
%     * manageable proof overhead, on par with C implementations
%
...
#! Shallow Embedding
  ...
  \begin{minipage}[t]{.35\textwidth}
    \begin{lstlisting}[escapechar=!]
      ...
      fib n = do {
        t <- ll_icmp_ule n 1;
        llc_if!\mknd{stmtif}! t (return n) (do {
