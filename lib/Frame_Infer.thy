...
lemmas [vcg_prep_external_drules] = pure_part_split_conj  
  


subsection \<open>Entails Connective\<close>
definition "entails" (infix "\<turnstile>" 25) where "P \<turnstile> Q \<equiv> \<forall>s. P s \<longrightarrow> Q s"
