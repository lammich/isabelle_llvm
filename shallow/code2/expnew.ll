...
define i64 @LLVM_Shallow_exp(i64 %i) {
  ...
  start:
    ...
    %s1 = insertvalue { i64, i64 } %s, i64 %i, 1
    %x = call { i64, i64 } @LLVM_Shallow_exp_0 ({ i64, i64 } %s1)
...
define { i64, i64 } @LLVM_Shallow_exp_0({ i64, i64 } %s) {
  ...
  then:
    ...
    %i1 = extractvalue { i64, i64 } %s, 1
    %c1 = mul i64 %c, 2
    %i2 = sub i64 %i1, 1
    %s1 = insertvalue { i64, i64 } zeroinitializer, i64 %c1, 0
    %x = insertvalue { i64, i64 } %s1, i64 %i2, 1
