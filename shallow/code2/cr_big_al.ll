...
define { i64, { i64, i64* } } @Array_List_arl_resize(i64 %c, { i64, { i64, i64* } } %al) {
  ...
  ctd_if:
    ...
    %a1 = call i8* @isabelle_llvm_calloc (i64 %caa, i64 %d)
    %a1a = bitcast i8* %a1 to i64*
    call void @LLVM_Shallow_RS_arraycpy (i64* %a1a, i64* %a, i64 %l)
    %e = bitcast i64* %a to i8*
    call void @isabelle_llvm_free (i8* %e)
    %xaa = insertvalue { i64, { i64, i64* } } zeroinitializer, i64 %l, 0
    %xd = insertvalue { i64, i64* } zeroinitializer, i64 %caa, 0
    %x1a = insertvalue { i64, i64* } %xd, i64* %a1a, 1
    %x2 = insertvalue { i64, { i64, i64* } } %xaa, { i64, i64* } %x1a, 1
    ret { i64, { i64, i64* } } %x2
}
...
define i64 @cr_big_al(i64 %n) {
  ...
  start:
    ...
    %aa = call i8* @isabelle_llvm_calloc (i64 8, i64 %a)
    %ab = bitcast i8* %aa to i64*
    %xa = insertvalue { i64, { i64, i64* } } zeroinitializer, i64 0, 0
    %xb = insertvalue { i64, i64* } zeroinitializer, i64 8, 0
    %xc = insertvalue { i64, i64* } %xb, i64* %ab, 1
    %aaa = insertvalue { i64, { i64, i64* } } %xa, { i64, i64* } %xc, 1
    %xd = insertvalue { i64, { i64, { i64, i64* } } } zeroinitializer, i64 %n, 0
    %xe = insertvalue { i64, { i64, { i64, i64* } } } %xd, { i64, { i64, i64* } } %aaa, 1
    %xaa = call { i64, { i64, { i64, i64* } } } @LLVM_Examples_cr_big_al_0 ({ i64, { i64, { i64, i64* } } } %xe)
    %uu = extractvalue { i64, { i64, { i64, i64* } } } %xaa, 0
    %aba = extractvalue { i64, { i64, { i64, i64* } } } %xaa, 1
    %xf = insertvalue { i64, i64 } zeroinitializer, i64 %n, 0
    %xg = insertvalue { i64, i64 } %xf, i64 0, 1
    %xba = call { i64, i64 } @LLVM_Examples_cr_big_al_1 ({ i64, { i64, i64* } } %aba, { i64, i64 } %xg)
