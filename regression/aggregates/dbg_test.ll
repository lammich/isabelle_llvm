...
%struct.testuc_t = type { i32, i64, i16 }

@.str = private unnamed_addr constant [11 x i8] c"Error: %s\0A\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"%zd %zd\0A\00", align 1
...
define dso_local i32 @main() #3 {
  ...
  %3 = alloca %struct.testuc_t*, align 8
  %4 = alloca i64, align 8
  store i32 0, i32* %1, align 4
  store i64 24, i64* %2, align 8
  store %struct.testuc_t* null, %struct.testuc_t** %3, align 8
  %5 = load %struct.testuc_t*, %struct.testuc_t** %3, align 8
  %6 = getelementptr inbounds %struct.testuc_t, %struct.testuc_t* %5, i64 1
  %7 = bitcast %struct.testuc_t* %6 to i8*
  %8 = ptrtoint i8* %7 to i64
  store i64 %8, i64* %4, align 8
  %9 = load i64, i64* %2, align 8
  %10 = load i64, i64* %4, align 8
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i64 %9, i64 %10)
  ret i32 0
}
