...
define void @__isabelle_llvm_par_wrapper_0_1 (i8 * %clpv) {
  ...
  %res = call i64* @Sorting_Export_Code_ll_icmp_ult_f_024687278 ({ i64*, { i64, i64 } } %arg)
...
define void @__isabelle_llvm_par_wrapper_1_1 (i8 * %clpv) {
  ...
  %res = call { i64, { i64, i8* } }* @Sorting_Export_Code_strcmp_impl_f_025453966 ({ { i64, { i64, i8* } }*, { i64, i64 } } %arg)
...
define { i64, { i64, i8* } }* @str_pdqsort({ i64, { i64, i8* } }* %x, i64 %x1, i64 %x2) {
  ...
  then:
    ...
    %x5 = call { i64, { i64, i8* } }* @Sorting_Export_Code_str_pdqsort_impl_f_025880596 ({ i1, { { i64, { i64, i8* } }*, { i64, { i64, i64 } } } } %x4)
    br label %ctd_if
...
define i64* @pdqsort(i64* %x, i64 %x1, i64 %x2) {
  ...
  then:
    ...
    %x5 = call i64* @Sorting_Export_Code_unat_pdqsort_impl_f_025117528 ({ i1, { i64*, { i64, { i64, i64 } } } } %x4)
    br label %ctd_if
...
define i64* @Sorting_Export_Code_ll_icmp_ult_f_024687278({ i64*, { i64, i64 } } %x) {
  ...
  thena:
    ...
    %xma = call i64* @Sorting_Export_Code_ll_icmp_ult_f_024687278 ({ i64*, { i64, i64 } } %xqa)
    %xna = sub i64 %a1a, %a2b
    %xoaa = sub i64 %a2a, 1
    ...
    %xpaa = call i64* @Sorting_Export_Code_ll_icmp_ult_f_024687278 ({ i64*, { i64, i64 } } %xua)
...
define i64* @Sorting_Export_Code_ll_icmp_ult_f_024766004(i64* %ai, { i64*, { i64, { i64, i64 } } } %x) {
  ...
  elsea:
    ...
    %xha = call i64* @Sorting_Export_Code_ll_icmp_ult_f_024766004 (i64* %ai, { i64*, { i64, { i64, i64 } } } %xra)
    %xia = sub i64 %a2b, 1
    ...
    %x3 = call i64* @Sorting_Export_Code_ll_icmp_ult_f_024766004 (i64* %ai, { i64*, { i64, { i64, i64 } } } %x2)
    br label %ctd_ifa
...
define i64* @Sorting_Export_Code_ll_icmp_ult_f_025380092({ i64*, { i64, { i64, i64 } } } %x) {
  ...
  ctd_ifb:
    ...
    %xha = call i64* @Sorting_Export_Code_ll_icmp_ult_f_025380092 ({ i64*, { i64, { i64, i64 } } } %yaa)
    %xia = sub i64 %a2b, 1
    ...
    %x28 = call i64* @Sorting_Export_Code_ll_icmp_ult_f_025380092 ({ i64*, { i64, { i64, i64 } } } %x27)
    br label %ctd_ifa
...
define { i64, { i64, i8* } }* @Sorting_Export_Code_strcmp_impl_f_025453966({ { i64, { i64, i8* } }*, { i64, i64 } } %x) {
  ...
  thena:
    ...
    %xma = call { i64, { i64, i8* } }* @Sorting_Export_Code_strcmp_impl_f_025453966 ({ { i64, { i64, i8* } }*, { i64, i64 } } %xqa)
    %xna = sub i64 %a1a, %a2b
    %xoaa = sub i64 %a2a, 1
    %xsa = insertvalue { i64, i64 } zeroinitializer, i64 %xna, 0
    %tmpbb = insertvalue { i64, i64 } %xsa, i64 %xoaa, 1
    ...
    %xpaa = call { i64, { i64, i8* } }* @Sorting_Export_Code_strcmp_impl_f_025453966 ({ { i64, { i64, i8* } }*, { i64, i64 } } %xua)
...
define i64* @Sorting_Export_Code_strcmp_impl_f_025532528({ i64, { i64, i8* } }* %ai, { i64*, { i64, { i64, i64 } } } %x) {
  ...
  elsea:
    ...
    %xqa = insertvalue { i64*, { i64, { i64, i64 } } } zeroinitializer, i64* %a1c, 0
    %xra = insertvalue { i64*, { i64, { i64, i64 } } } %xqa, { i64, { i64, i64 } } %tmpda, 1
    %xha = call i64* @Sorting_Export_Code_strcmp_impl_f_025532528 ({ i64, { i64, i8* } }* %ai, { i64*, { i64, { i64, i64 } } } %xra)
    %xia = sub i64 %a2b, 1
    %xta = insertvalue { i64, i64 } zeroinitializer, i64 %a1b, 0
    %tmpeb = insertvalue { i64, i64 } %xta, i64 %xia, 1
    %xua = insertvalue { i64, { i64, i64 } } zeroinitializer, i64 %a2c, 0
    ...
    %xva = insertvalue { i64*, { i64, { i64, i64 } } } zeroinitializer, i64* %xha, 0
    %x2 = insertvalue { i64*, { i64, { i64, i64 } } } %xva, { i64, { i64, i64 } } %tmpfa, 1
    %x3 = call i64* @Sorting_Export_Code_strcmp_impl_f_025532528 ({ i64, { i64, i8* } }* %ai, { i64*, { i64, { i64, i64 } } } %x2)
    br label %ctd_ifa
...
define { i64, { i64, i8* } }* @Sorting_Export_Code_strcmp_impl_f_026143160({ { i64, { i64, i8* } }*, { i64, { i64, i64 } } } %x) {
  ...
  ctd_ifb:
    ...
    %xha = call { i64, { i64, i8* } }* @Sorting_Export_Code_strcmp_impl_f_026143160 ({ { i64, { i64, i8* } }*, { i64, { i64, i64 } } } %yaa)
    %xia = sub i64 %a2b, 1
    %yca = insertvalue { i64, i64 } zeroinitializer, i64 %a1b, 0
    %tmpeb = insertvalue { i64, i64 } %yca, i64 %xia, 1
    %yda = insertvalue { i64, { i64, i64 } } zeroinitializer, i64 %a2c, 0
    ...
    %x28 = call { i64, { i64, i8* } }* @Sorting_Export_Code_strcmp_impl_f_026143160 ({ { i64, { i64, i8* } }*, { i64, { i64, i64 } } } %x27)
    br label %ctd_ifa
...
define { i64, { i64, i8* } }* @Sorting_Export_Code_str_pdqsort_impl_f_025880596({ i1, { { i64, { i64, i8* } }*, { i64, { i64, i64 } } } } %x) {
  ...
  thens:
    ...
    %x24 = call { i64, { i64, i8* } }* @Sorting_Export_Code_str_pdqsort_impl_f_025880596 ({ i1, { { i64, { i64, i8* } }*, { i64, { i64, i64 } } } } %x23)
    br label %ctd_ifs
  ...
  elsff:
    ...
    %yaaaa5 = call { i64, { i64, i8* } }* @Sorting_Export_Code_str_pdqsort_impl_f_025880596 ({ i1, { { i64, { i64, i8* } }*, { i64, { i64, i64 } } } } %yua)
    ...
    %x61 = call { i64, { i64, i8* } }* @Sorting_Export_Code_str_pdqsort_impl_f_025880596 ({ i1, { { i64, { i64, i8* } }*, { i64, { i64, i64 } } } } %x60)
    br label %ctd_igf
...
define i64* @Sorting_Export_Code_unat_pdqsort_impl_f_025117528({ i1, { i64*, { i64, { i64, i64 } } } } %x) {
  ...
  thens:
    ...
    %x24 = call i64* @Sorting_Export_Code_unat_pdqsort_impl_f_025117528 ({ i1, { i64*, { i64, { i64, i64 } } } } %x23)
    br label %ctd_ifs
  ...
  elsff:
    ...
    %yaaaa5 = call i64* @Sorting_Export_Code_unat_pdqsort_impl_f_025117528 ({ i1, { i64*, { i64, { i64, i64 } } } } %yua)
    %ybaaa4 = add i64 %a1e1, 1
    %ywa = insertvalue { i64, i64 } zeroinitializer, i64 %a1c, 0
    %tmpdl = insertvalue { i64, i64 } %ywa, i64 %xxaa3, 1
    %yxa1 = insertvalue { i64, { i64, i64 } } zeroinitializer, i64 %ybaaa4, 0
    ...
    %x61 = call i64* @Sorting_Export_Code_unat_pdqsort_impl_f_025117528 ({ i1, { i64*, { i64, { i64, i64 } } } } %x60)
    br label %ctd_igf
...
define i64* @Monadify_M_CONST_Sorting_Parsort_sort_impl_context_par_sort_aux_impl_LLVM_Shallow_ll_icmp_ult(i64* %x, i64 %x1, i64 %x2) {
  ...
  start:
    ...
    %x4 = call i64* @Sorting_Export_Code_ll_icmp_ult_f_024687278 ({ i64*, { i64, i64 } } %x3)
    ret i64* %x4
}
...
define { i64, { i64, i8* } }* @Monadify_M_CONST_Sorting_Parsort_sort_impl_context_par_sort_aux_impl_Sorting_Strings_strcmp_impl({ i64, { i64, i8* } }* %x, i64 %x1, i64 %x2) {
  ...
  start:
    ...
    %x4 = call { i64, { i64, i8* } }* @Sorting_Export_Code_strcmp_impl_f_025453966 ({ { i64, { i64, i8* } }*, { i64, i64 } } %x3)
    ret { i64, { i64, i8* } }* %x4
}
...
define i64* @Monadify_M_CONST_Sorting_Introsort_sort_impl_context_introsort_aux_impl_LLVM_Shallow_ll_icmp_ult(i64* %x, i64 %x1, i64 %x2, i64 %x3) {
  ...
  start:
    ...
    %x5 = call i64* @Sorting_Export_Code_ll_icmp_ult_f_025380092 ({ i64*, { i64, { i64, i64 } } } %x4)
    ret i64* %x5
}
...
define { i64, { i64, i8* } }* @Monadify_M_CONST_Sorting_Introsort_sort_impl_context_introsort_aux_impl_Sorting_Strings_strcmp_impl({ i64, { i64, i8* } }* %x, i64 %x1, i64 %x2, i64 %x3) {
  ...
  start:
    ...
    %x5 = call { i64, { i64, i8* } }* @Sorting_Export_Code_strcmp_impl_f_026143160 ({ { i64, { i64, i8* } }*, { i64, { i64, i64 } } } %x4)
    ret { i64, { i64, i8* } }* %x5
}
...
define i64* @Monadify_M_CONST_Sorting_Introsort_parameterized_sort_impl_context_introsort_aux_param_impl_Monad_return_Monad_return_Proto_IICF_EOArray_eo_extract_impl_LLVM_DS_Array_array_upd_Sorting_Ex_Array_Idxs_idxs_comp_idx_pcmp_impl_LLVM_Shallow_ll_icmp_ult(i64* %x, i64* %x1, i64 %x2, i64 %x3, i64 %x4) {
  ...
  start:
    ...
    %x6 = call i64* @Sorting_Export_Code_ll_icmp_ult_f_024766004 (i64* %x, { i64*, { i64, { i64, i64 } } } %x5)
    ret i64* %x6
}
...
define i64* @Monadify_M_CONST_Sorting_Introsort_parameterized_sort_impl_context_introsort_aux_param_impl_Monad_return_Monad_return_Proto_IICF_EOArray_eo_extract_impl_LLVM_DS_Array_array_upd_Sorting_Ex_Array_Idxs_idxs_comp_idx_pcmp_impl_Sorting_Strings_strcmp_impl({ i64, { i64, i8* } }* %x, i64* %x1, i64 %x2, i64 %x3, i64 %x4) {
  ...
  start:
    ...
    %xba = insertvalue { i64*, { i64, { i64, i64 } } } zeroinitializer, i64* %x1, 0
    %x5 = insertvalue { i64*, { i64, { i64, i64 } } } %xba, { i64, { i64, i64 } } %tmpab, 1
    %x6 = call i64* @Sorting_Export_Code_strcmp_impl_f_025532528 ({ i64, { i64, i8* } }* %x, { i64*, { i64, { i64, i64 } } } %x5)
    ret i64* %x6
}
